...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/1-figures/1-learning-agent-rl.png" alt="学习型智能体通过奖励信号自我进化" width="90%"/>
  <p>图 1.5 学习型智能体的强化学习循环：从随机探索到策略进化</p>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/1-figures/1-thought-action-observation.png" alt="Thought-Action-Observation 循环" width="90%"/>
  <p>图 1.7 Thought → Action → Observation 三阶段循环：LLM 智能体的行动范式</p>
</div>
...
<div align="center">
  <img src="https://raw.githubusercontent.com/datawhalechina/Hello-Agents/main/docs/images/1-figures/1-multi-agent-framework.png" alt="多智能体协作框架" width="90%"/>
  <p>图 1.8 多智能体协作框架：Coordinator 分发任务，角色分工并行推进</p>
</div>
...
> 参考答案仅供参考，详见 [第一章 习题参考答案](./第一章%20习题参考答案.md)。
